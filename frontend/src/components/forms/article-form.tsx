...
// Validation rules for create mode (code is required)
...
// Validation rules for edit mode (code is not required since it's already set)
const editValidationRules = {
  code: { minLength: 2, maxLength: 20 }, // Not required in edit mode
  name: { required: true, minLength: 2, maxLength: 100 },
  brand: { maxLength: 50 },
  category: { maxLength: 50 },
  classification_id: { required: true },
...
// Type for pending image (file not yet uploaded)
