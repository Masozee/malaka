...
export default function EditQuotationPage() {
  ...
  const breadcrumbs = [
    ...
    { label: quotation?.quotation_number || 'Loading...', href: quotation ? `/sales/quotations/${quotation.id}` : '#' },
    { label: 'Edit' }
  ]
      ...
      <TwoLevelLayout>
        ...
        <div className="flex-1 p-6">
          <Card className="p-6 text-center">
            ...
            <p className="text-muted-foreground mb-4">The quotation you're trying to edit doesn't exist.</p>
            <Button asChild>
  ...
  return (
    <TwoLevelLayout>
      <Header 
        ...
        description="Edit quotation details and items"
        breadcrumbs={breadcrumbs}
        actions={
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="quotation_date"
                type="date"
                value={formData.quotation_date ? formatDateForInput(formData.quotation_date) : ''}
            ...
            <div className="space-y-2">
              ...
              <Input
                id="valid_until"
                type="date"
                value={formData.valid_until ? formatDateForInput(formData.valid_until) : ''}
