...
import { stockAdjustmentService } from '@/services/inventory'
...
export default function NewStockAdjustmentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addToast({ type: 'success', title: 'Stock adjustment created successfully' })
      router.push('/inventory/adjustments')
    } catch (err) {
      console.error('Error creating stock adjustment:', err)
      addToast({ type: 'error', title: 'Failed to create stock adjustment' })
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <TwoLevelLayout>
      ...
      <div className="flex-1 overflow-auto p-6 space-y-6">
        ...
        {/* Page title */}
        <div className="-mt-2">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">New Stock Adjustment</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">Create an inventory quantity adjustment</p>
        </div>
