...
import { returnSupplierService } from '@/services/inventory'
...
export default function NewReturnSupplierPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true)
      await returnSupplierService.createReturn({
  ...
  return (
    <TwoLevelLayout>
      ...
      <div className="flex-1 overflow-auto p-6 space-y-6">
        <button
          onClick={() => router.push('/inventory/return-supplier')}
          className="flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors"
        >
          <HugeiconsIcon icon={ArrowLeft01Icon} className="w-4 h-4" />
          Back to Return Supplier
        </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <Card className="lg:col-span-2">
              <CardHeader>
                ...
                <CardDescription>Select supplier and specify return reason</CardDescription>
              </CardHeader>
            ...
            <div className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <Button type="button" variant="outline" className="w-full" onClick={() => router.push('/inventory/return-supplier')}>
                    Cancel
                  </Button>
                </CardContent>
              </Card>
