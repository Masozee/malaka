...
export default function SettingsPage() {
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select value={settings.baseCurrency} onValueChange={(value) => handleSettingChange('baseCurrency', value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={settings.thousandSeparator} onValueChange={(value) => handleSettingChange('thousandSeparator', value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              ...
              <Select value={settings.decimalSeparator} onValueChange={(value) => handleSettingChange('decimalSeparator', value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              onChange={(e) => handleSettingChange('enableTaxInclusive', e.target.checked)}
              className="rounded"
            />
  ...
  const renderApiSettings = () => (
    <div className="space-y-6">
      ...
      {[
        { key: 'ramayana', color: 'text-red-600' },
        { key: 'matahari', color: 'text-blue-600' },
        { key: 'yogya', color: 'text-green-600' },
        { key: 'star', color: 'text-purple-600' }
      ].map((app) => {
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) => handleSettingChange(app.key, { ...appSettings, enabled: e.target.checked })}
                  className="rounded"
                />
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleSettingChange(app.key, { ...appSettings, apiUrl: e.target.value })}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleSettingChange(app.key, { ...appSettings, apiKey: e.target.value })}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleSettingChange(app.key, { ...appSettings, timeout: parseInt(e.target.value) })}
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleSettingChange(app.key, { ...appSettings, retryAttempts: parseInt(e.target.value) })}
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleSettingChange(app.key, { ...appSettings, syncInterval: parseInt(e.target.value) })}
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => handleSettingChange(app.key, { ...appSettings, enableSync: e.target.checked })}
                      className="rounded"
                    />
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={settings.smtpSecurity} onValueChange={(value) => handleSettingChange('smtpSecurity', value)}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) => handleSettingChange('requirePasswordNumbers', e.target.checked)}
                className="rounded"
              />
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) => handleSettingChange('requirePasswordSymbols', e.target.checked)}
                className="rounded"
              />
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={settings.dbBackupInterval} onValueChange={(value) => handleSettingChange('dbBackupInterval', value)}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) => handleSettingChange('enableStockAlerts', e.target.checked)}
                className="rounded"
              />
