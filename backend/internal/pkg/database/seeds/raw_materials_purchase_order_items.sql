...
(
    (SELECT id FROM purchase_orders WHERE supplier_id = '6d1ec8e0-3d38-42db-988b-8a253d0de747' AND notes LIKE '%kulit premium%'),
...
(
    (SELECT id FROM purchase_orders WHERE supplier_id = '04505b14-da85-4d71-a42f-1187dbb6fbf8' AND notes LIKE '%karet dan sintetis%'),
...
(
    (SELECT id FROM purchase_orders WHERE supplier_id = 'fb637676-bc29-48c8-82a8-dfe09790d520' AND notes LIKE '%kain dan lem%'),
