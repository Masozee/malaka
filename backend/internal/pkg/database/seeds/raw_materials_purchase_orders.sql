...
(
    ...
    '2025-01-27 17:00:00+07:00',
    'approved',
    12500000.00, -- Will be updated based on items
    'Order untuk bahan kulit premium produksi Nike Air Max dan Business Formal',
    NOW(),
    NOW()
),
...
(
    ...
    '2025-01-28 17:00:00+07:00',
    'approved',
    8500000.00, -- Will be updated based on items
    'Order untuk bahan karet dan sintetis produksi sepatu casual',
    NOW(),
    NOW()
),
...
(
    ...
    '2025-01-29 17:00:00+07:00',
    'approved',
    6800000.00, -- Will be updated based on items
    'Order untuk bahan kain dan lem produksi sepatu sports',
    NOW(),
    NOW()
);