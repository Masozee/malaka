...
-- Now create the journal entry lines using ACTUAL account codes
...
-- JE-2024-001: Opening Balance Entry (using actual account codes from database)
...
('22222222-2222-2222-2222-222222222009', '11111111-1111-1111-1111-111111111004', 1, (SELECT id FROM chart_of_accounts WHERE account_code = '2301'), 'Beban gaji karyawan', 18000000, 0, '2024-07-15 16:45:00', '2024-07-15 16:45:00'),
