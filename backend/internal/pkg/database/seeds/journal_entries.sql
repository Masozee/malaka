...
('22222222-2222-2222-2222-222222222007', '11111111-1111-1111-1111-111111111002', 1, (SELECT id FROM chart_of_accounts WHERE account_code = '1111'), 'Penerimaan kas dari penjualan', 15000000, 0, 'INV-001', NULL, '2024-07-03 14:30:00', '2024-07-03 14:30:00'),
('22222222-2222-2222-2222-222222222008', '11111111-1111-1111-1111-111111111002', 2, (SELECT id FROM chart_of_accounts WHERE account_code = '4110'), 'Pendapatan penjualan sepatu', 0, 15000000, 'INV-001', NULL, '2024-07-03 14:30:00', '2024-07-03 14:30:00'),

-- JE-2024-003: Purchase Transaction
('22222222-2222-2222-2222-222222222009', '11111111-1111-1111-1111-111111111003', 1, (SELECT id FROM chart_of_accounts WHERE account_code = '1131'), 'Pembelian persediaan sepatu', 25000000, 0, 'PO-001', NULL, '2024-07-05 10:15:00', '2024-07-05 10:15:00'),
('22222222-2222-2222-2222-222222222010', '11111111-1111-1111-1111-111111111003', 2, (SELECT id FROM chart_of_accounts WHERE account_code = '2110'), 'Hutang kepada supplier', 0, 25000000, 'PO-001', NULL, '2024-07-05 10:15:00', '2024-07-05 10:15:00'),

-- JE-2024-004: Salary Payment
('22222222-2222-2222-2222-222222222011', '11111111-1111-1111-1111-111111111004', 1, (SELECT id FROM chart_of_accounts WHERE account_code = '5210'), 'Beban gaji karyawan', 18000000, 0, 'PAY-001', NULL, '2024-07-15 16:45:00', '2024-07-15 16:45:00'),
('22222222-2222-2222-2222-222222222012', '11111111-1111-1111-1111-111111111004', 2, (SELECT id FROM chart_of_accounts WHERE account_code = '1112'), 'Pembayaran gaji via bank', 0, 18000000, 'PAY-001', NULL, '2024-07-15 16:45:00', '2024-07-15 16:45:00'),

-- JE-2024-005: Operating Expenses
('22222222-2222-2222-2222-222222222013', '11111111-1111-1111-1111-111111111005', 1, (SELECT id FROM chart_of_accounts WHERE account_code = '5220'), 'Biaya sewa gedung', 8000000, 0, 'EXP-001', NULL, '2024-07-20 11:20:00', '2024-07-20 11:20:00'),
('22222222-2222-2222-2222-222222222014', '11111111-1111-1111-1111-111111111005', 2, (SELECT id FROM chart_of_accounts WHERE account_code = '5230'), 'Biaya listrik dan air', 4000000, 0, 'EXP-001', NULL, '2024-07-20 11:20:00', '2024-07-20 11:20:00'),
('22222222-2222-2222-2222-222222222015', '11111111-1111-1111-1111-111111111005', 3, (SELECT id FROM chart_of_accounts WHERE account_code = '1111'), 'Pembayaran tunai', 0, 12000000, 'EXP-001', NULL, '2024-07-20 11:20:00', '2024-07-20 11:20:00'),

-- JE-2024-006: Customer Payment  
('22222222-2222-2222-2222-222222222016', '11111111-1111-1111-1111-111111111006', 1, (SELECT id FROM chart_of_accounts WHERE account_code = '1112'), 'Penerimaan piutang via bank', 8000000, 0, 'RCP-001', NULL, '2024-07-25 13:10:00', '2024-07-25 13:10:00'),
('22222222-2222-2222-2222-222222222017', '11111111-1111-1111-1111-111111111006', 2, (SELECT id FROM chart_of_accounts WHERE account_code = '1121'), 'Pelunasan piutang dagang', 0, 8000000, 'RCP-001', NULL, '2024-07-25 13:10:00', '2024-07-25 13:10:00');