...
type PerformanceReview struct {
	...
	ReviewCycleID           string    `json:"review_cycle_id" gorm:"type:uuid;not null"`
...
type PerformanceReviewGoal struct {
	ID                     string  `json:"id" gorm:"type:uuid;primary_key;default:gen_random_uuid()"`
	PerformanceReviewID    string  `json:"performance_review_id" gorm:"type:uuid;not null"`
	GoalID                 string  `json:"goal_id" gorm:"type:uuid;not null"`
...
type PerformanceCompetencyEvaluation struct {
	ID                  string  `json:"id" gorm:"type:uuid;primary_key;default:gen_random_uuid()"`
	PerformanceReviewID string  `json:"performance_review_id" gorm:"type:uuid;not null"`
	CompetencyID        string  `json:"competency_id" gorm:"type:uuid;not null"`
