...
type DivisionRepository interface {
	...
	GetByID(ctx context.Context, id uuid.ID) (*entities.Division, error)
	GetAll(ctx context.Context) ([]*entities.Division, error)
	GetAllWithPagination(ctx context.Context, limit, offset int, search, status, sortOrder, companyID string) ([]*entities.Division, int, error)
	GetByCode(ctx context.Context, code string) (*entities.Division, error)
	GetByParentID(ctx context.Context, parentID uuid.ID) ([]*entities.Division, error)
