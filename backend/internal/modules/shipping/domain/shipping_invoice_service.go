...
type ShippingInvoiceService interface {
	...
	GetShippingInvoiceByID(ctx context.Context, id uuid.UUID) (*entities.ShippingInvoice, error)
	...
	GetShippingInvoicesByShipmentID(ctx context.Context, shipmentID uuid.UUID) ([]entities.ShippingInvoice, error)

	// GetShippingInvoicesByCourierID retrieves shipping invoices by courier ID
	GetShippingInvoicesByCourierID(ctx context.Context, courierID uuid.UUID) ([]entities.ShippingInvoice, error)
	...
	UpdateShippingInvoice(ctx context.Context, id uuid.UUID, request *dtos.UpdateShippingInvoiceRequest) (*entities.ShippingInvoice, error)

	// DeleteShippingInvoice deletes a shipping invoice by ID
	DeleteShippingInvoice(ctx context.Context, id uuid.UUID) error

	// PayShippingInvoice marks a shipping invoice as paid
	PayShippingInvoice(ctx context.Context, id uuid.UUID, request *dtos.PayShippingInvoiceRequest) (*entities.ShippingInvoice, error)
