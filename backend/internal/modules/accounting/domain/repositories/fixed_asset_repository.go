...
type FixedAssetRepository interface {
	...
	GetByID(ctx context.Context, id uuid.ID) (*entities.FixedAsset, error)
	...
	GetDepreciationByID(ctx context.Context, id uuid.ID) (*entities.FixedAssetDepreciation, error)
	GetDepreciationsByAsset(ctx context.Context, assetID uuid.ID) ([]*entities.FixedAssetDepreciation, error)
	UpdateDepreciation(ctx context.Context, depreciation *entities.FixedAssetDepreciation) error
	DeleteDepreciation(ctx context.Context, id uuid.ID) error

	// Disposal operations
	CreateDisposal(ctx context.Context, disposal *entities.FixedAssetDisposal) error
	GetDisposalByID(ctx context.Context, id uuid.ID) (*entities.FixedAssetDisposal, error)
	...
	DeleteDisposal(ctx context.Context, id uuid.ID) error
	...
	GetBookValues(ctx context.Context, companyID string, asOfDate time.Time) (map[uuid.ID]float64, error)
	...
	GetAssetUtilization(ctx context.Context, companyID string) (map[uuid.ID]float64, error)
	GetDisposalReport(ctx context.Context, companyID string, startDate, endDate time.Time) ([]*entities.FixedAssetDisposal, error)
	
	// Asset lifecycle
	GetAssetHistory(ctx context.Context, assetID uuid.ID) (map[string]interface{}, error)
	...
	RecalculateDepreciation(ctx context.Context, assetID uuid.ID) error
