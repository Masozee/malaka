...
type ProductionPlanRepository interface {
	...
	GetByID(ctx context.Context, id uuid.UUID) (*entities.ProductionPlan, error)
	...
	GetItems(ctx context.Context, planID uuid.UUID) ([]entities.ProductionPlanItem, error)
	GetItemByID(ctx context.Context, id uuid.UUID) (*entities.ProductionPlanItem, error)
	UpdateItemProgress(ctx context.Context, itemID uuid.UUID, producedQuantity int) error

	// Validation
	ExistsPlanNumber(ctx context.Context, planNumber string, excludeID ...uuid.UUID) (bool, error)
