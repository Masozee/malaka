...
curl -X GET http://localhost:8080/api/v1/masterdata/companies/
curl -X GET http://localhost:8080/api/v1/masterdata/users/
curl -X GET http://localhost:8080/api/v1/masterdata/articles/
curl -X GET http://localhost:8080/api/v1/masterdata/classifications/
curl -X GET http://localhost:8080/api/v1/masterdata/colors/
curl -X GET http://localhost:8080/api/v1/masterdata/models/
curl -X GET http://localhost:8080/api/v1/masterdata/sizes/
curl -X GET http://localhost:8080/api/v1/masterdata/barcodes/
curl -X GET http://localhost:8080/api/v1/masterdata/prices/
curl -X GET http://localhost:8080/api/v1/masterdata/suppliers/
curl -X GET http://localhost:8080/api/v1/masterdata/customers/
curl -X GET http://localhost:8080/api/v1/masterdata/warehouses/
curl -X GET http://localhost:8080/api/v1/masterdata/gallery-images/
curl -X GET http://localhost:8080/api/v1/masterdata/courier-rates/
curl -X GET http://localhost:8080/api/v1/masterdata/depstores/
curl -X GET http://localhost:8080/api/v1/masterdata/divisions/

# Shipping (5 modules - 100% complete)
curl -X GET http://localhost:8080/api/v1/shipping/couriers/
curl -X GET http://localhost:8080/api/v1/shipping/shipments/
curl -X GET http://localhost:8080/api/v1/shipping/airwaybills/
curl -X GET http://localhost:8080/api/v1/shipping/manifests/
curl -X GET http://localhost:8080/api/v1/shipping/invoices/
curl -X GET http://localhost:8080/api/v1/shipping/invoices/overdue
curl -X POST http://localhost:8080/api/v1/shipping/outbound-scans/

# Inventory (13 endpoints - 100% complete)
curl -X GET http://localhost:8080/api/v1/inventory/draft-orders/
curl -X GET http://localhost:8080/api/v1/inventory/purchase-orders/
curl -X GET http://localhost:8080/api/v1/inventory/goods-receipts/
curl -X GET http://localhost:8080/api/v1/inventory/transfers/
curl -X GET http://localhost:8080/api/v1/inventory/return-suppliers/
curl -X GET http://localhost:8080/api/v1/inventory/goods-issues/
curl -X GET http://localhost:8080/api/v1/inventory/adjustments/
curl -X GET http://localhost:8080/api/v1/inventory/opnames/
curl -X GET http://localhost:8080/api/v1/inventory/stock/balance
curl -X GET http://localhost:8080/api/v1/inventory/stock/movements

# Sales (11 endpoints - 100% complete)
curl -X GET http://localhost:8080/api/v1/sales/orders/
curl -X GET http://localhost:8080/api/v1/sales/invoices/
curl -X GET http://localhost:8080/api/v1/sales/pos-transactions/
curl -X GET http://localhost:8080/api/v1/sales/online-orders/
curl -X GET http://localhost:8080/api/v1/sales/consignment-sales/
curl -X GET http://localhost:8080/api/v1/sales/returns/
curl -X GET http://localhost:8080/api/v1/sales/promotions/
curl -X GET http://localhost:8080/api/v1/sales/targets/
curl -X GET http://localhost:8080/api/v1/sales/kompetitors/
curl -X GET http://localhost:8080/api/v1/sales/proses-margins/
curl -X GET http://localhost:8080/api/v1/sales/rekonsiliasi/

# Finance (14 endpoints - 100% complete)
curl -X GET http://localhost:8080/api/v1/finance/cash-banks/
curl -X GET http://localhost:8080/api/v1/finance/payments/
curl -X GET http://localhost:8080/api/v1/finance/invoices/
curl -X GET http://localhost:8080/api/v1/finance/accounts-payable/
curl -X GET http://localhost:8080/api/v1/finance/accounts-receivable/
curl -X GET http://localhost:8080/api/v1/finance/cash-disbursements/
curl -X GET http://localhost:8080/api/v1/finance/cash-receipts/
curl -X GET http://localhost:8080/api/v1/finance/bank-transfers/
curl -X GET http://localhost:8080/api/v1/finance/cash-opening-balances/
curl -X GET http://localhost:8080/api/v1/finance/purchase-vouchers/
curl -X GET http://localhost:8080/api/v1/finance/expenditure-requests/
curl -X GET http://localhost:8080/api/v1/finance/check-clearance/
curl -X GET http://localhost:8080/api/v1/finance/monthly-closing/
curl -X GET http://localhost:8080/api/v1/finance/cash-book/

# Accounting (3 modules - 19% complete, 27 endpoints)
curl -X GET http://localhost:8080/api/v1/accounting/general-ledger/
curl -X GET http://localhost:8080/api/v1/accounting/general-ledger/account/12345678-1234-1234-1234-123456789012/balance
curl -X GET http://localhost:8080/api/v1/accounting/general-ledger/account/12345678-1234-1234-1234-123456789012/report?start_date=2025-01-01&end_date=2025-12-31
curl -X POST http://localhost:8080/api/v1/accounting/general-ledger/account/12345678-1234-1234-1234-123456789012/recalculate
curl -X GET http://localhost:8080/api/v1/accounting/journal-entries/
curl -X POST http://localhost:8080/api/v1/accounting/journal-entries/12345678-1234-1234-1234-123456789012/post
curl -X POST http://localhost:8080/api/v1/accounting/journal-entries/12345678-1234-1234-1234-123456789012/reverse
curl -X POST http://localhost:8080/api/v1/accounting/journal-entries/12345678-1234-1234-1234-123456789012/lines
curl -X GET http://localhost:8080/api/v1/accounting/journal-entries/status?status=POSTED
curl -X GET http://localhost:8080/api/v1/accounting/journal-entries/date-range?start_date=2025-01-01&end_date=2025-12-31
curl -X GET http://localhost:8080/api/v1/accounting/journal-entries/company/:company_id
curl -X GET http://localhost:8080/api/v1/accounting/journal-entries/company/:company_id/unposted
curl -X GET http://localhost:8080/api/v1/accounting/journal-entries/register?company_id=COMP001&start_date=2025-01-01&end_date=2025-12-31

# Authentication
curl -X POST http://localhost:8080/api/v1/masterdata/users/login
```
