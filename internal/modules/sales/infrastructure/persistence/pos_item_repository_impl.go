...
func (r *PosItemRepositoryImpl) Create(ctx context.Context, item *entities.PosItem) error {
	query := `INSERT INTO pos_items (id, pos_transaction_id, article_id, quantity, unit_price, total_price, created_at, updated_at) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)`
...
func (r *PosItemRepositoryImpl) GetByID(ctx context.Context, id string) (*entities.PosItem, error) {
	query := `SELECT id, pos_transaction_id, article_id, quantity, unit_price, total_price, created_at, updated_at FROM pos_items WHERE id = $1`
...
func (r *PosItemRepositoryImpl) Update(ctx context.Context, item *entities.PosItem) error {
	query := `UPDATE pos_items SET pos_transaction_id = $1, article_id = $2, quantity = $3, unit_price = $4, total_price = $5, updated_at = $6 WHERE id = $7`
...
func (r *PosItemRepositoryImpl) Delete(ctx context.Context, id string) error {
